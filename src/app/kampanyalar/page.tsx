...
const campaigns = [
  {
    ...
    description: "2.000 TL ve üzeri alışverişlerde %10 Bee hoş geldin indirimi.",
    badge: "BEE10",
    detail: "Ödeme sayfasında BEE10 kodunu girin. Minimum sepet 2.000 TL.",
    code: "BEE10",
  ...
  },
  {
    ...
    description: "3.500 TL ve üzeri yaz alışverişlerinde %15 ek indirim.",
    badge: "YAZ SEÇKİSİ",
    detail: "Ödeme sayfasında YAZ15 kodunu uygulayın.",
    code: "YAZ15",
    image: "https://images.unsplash.com/photo-1615634260167-c8cdede054de?auto=format&fit=crop&w=1400&q=85",
  },
  {
    title: "Ücretsiz Kargo",
    description: "1.500 TL ve üzeri tüm siparişlerde kargo Bee’den.",
    badge: "HER ZAMAN",
    detail: "Sepette ve ödeme özetinde ücretsiz kargo eşiği otomatik hesaplanır.",
