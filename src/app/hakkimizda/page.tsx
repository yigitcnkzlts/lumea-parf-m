...
import { AboutGalleryGrid } from "@/components/about/about-gallery";
      ...
      <section className="section-shell">
        ...
        <div className="mt-24">
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-neutral-600">
            Kendi mağaza ve marka fotoğraflarınızı images/about klasörüne koyun. Dosya yoksa geçici görseller gösterilir.
          </p>
          <AboutGalleryGrid />
        </div>
