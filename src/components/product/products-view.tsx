...
export function ProductsView({ initial }: { initial: InitialFilters }) {
  ...
  return (
    <main className="mx-auto max-w-[1500px] px-5 py-12 lg:px-8 lg:py-16">
      <div className="mb-12 text-center"><p className="text-[10px] tracking-[.3em] text-[#936d40]">LUMÉA KOLEKSİYONU</p><h1 className="mt-3 font-serif text-5xl md:text-7xl">Tüm Parfümler</h1><p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-neutral-500">Sizi anlatan kokuyu seçkin parfüm koleksiyonumuzda keşfedin.</p></div>
