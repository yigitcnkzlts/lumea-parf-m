      ...
      <div className="mx-auto max-w-[1500px] px-5 py-6 lg:px-8">
        ...
        <div className="mt-7 grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:gap-16">
          ...
          <section className="lg:py-5">
            ...
            {product.stock ? (
              <button type="button" onClick={buyNow} className="mt-3 w-full border border-black px-5 py-4 text-xs tracking-[.16em] transition hover:bg-black hover:text-white">
                HEMEN SATIN AL
              </button>
            ) : null}
